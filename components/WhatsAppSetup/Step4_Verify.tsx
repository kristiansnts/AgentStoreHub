...
const Step4_Verify: React.FC<Props> = ({ logs, onComplete }) => {
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col w-full mt-8">
        ...
        <div className="px-6 py-6">
          <div className="flex gap-3 items-start p-4 bg-yellow-50 dark:bg-yellow-900/10 rounded-2xl border border-yellow-100/50 dark:border-yellow-900/20">
            <Icon name="lightbulb" className="text-yellow-600 dark:text-yellow-500 shrink-0" />
            <div className="flex flex-col gap-1">
              <p className="text-sm font-bold text-yellow-800 dark:text-yellow-500">Not connecting?</p>
              <p className="text-xs text-yellow-800/80 dark:text-yellow-500/80 leading-relaxed">
                Ensure your WAHA instance port (3000) is exposed and your firewall allows incoming traffic.
              </p>
            </div>
          </div>
        </div>
