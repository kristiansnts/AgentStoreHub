    ...
    return (
        <div className="animate-in fade-in duration-300">
            <header className="flex items-center bg-white dark:bg-[#0f1623] p-4 pb-2 justify-between sticky top-0 z-10 backdrop-blur-md bg-white/80 dark:bg-[#0f1623]/80">
                <div onClick={() => navigate(-1)} className="text-gray-900 dark:text-white flex size-12 shrink-0 items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer">
            ...
            <div className="p-4 mt-6">
                <div className="bg-primary/5 dark:bg-primary/10 rounded-3xl p-6 border border-primary/10 dark:border-primary/20 flex flex-col items-center text-center gap-3">
                    ...
                    <button onClick={() => navigate('/home')} className="mt-2 bg-primary text-white font-bold py-2 px-6 rounded-full active:scale-95 transition-all">
                        Browse Marketplace
                    </button>
                </div>
            </div>
